...
namespace HR_Taxonomy_Change_Management.Migrations
{
    ...
    [Migration("20230825152230_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChangeDetailStatus", b =>
                {
                    ...
                    b.HasKey("ChangeDetailId", "StatusesStatusId");

                    b.HasIndex("StatusesStatusId");

                    b.ToTable("ChangeDetailStatus");
                });
            ...
            modelBuilder.Entity("HR_Taxonomy_Change_Management.Repository.Model.Status", b =>
                {
            ...
            modelBuilder.Entity("HR_Taxonomy_Change_Management.Repository.Model.StatusType", b =>
                {
                    b.Property<int>("StatusTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RequestStatus", b =>
                {
                    ...
                    b.HasKey("RequestId", "StatusesStatusId");
            ...
            modelBuilder.Entity("ChangeDetailStatus", b =>
                {
                    ...
                    b.HasOne("HR_Taxonomy_Change_Management.Repository.Model.Status", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HR_Taxonomy_Change_Management.Repository.Model.Status", b =>
                {
                    b.HasOne("HR_Taxonomy_Change_Management.Repository.Model.StatusType", "StatusTypes")
                        .WithMany("Statuses")
